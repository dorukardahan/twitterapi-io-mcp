...
Source: https://twitterapi.io/twitter-stream/subscription
...
```json
{
  ...
  "arguments": {
    "guide_name": "twitter_stream_subscription"
  }
}
```
...
```json
{
  ...
  "arguments": {
    "url": "/twitter-stream/subscription"
  }
}
```
...
_Scraped at: 2025-12-18T10:06:02.426Z_
