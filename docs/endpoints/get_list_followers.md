...
- API URL: `'https://api.twitterapi.io/twitter/list/followers?list_id=LIST_ID&cursor=CURSOR'`
...
```bash
curl --request GET \
  --url 'https://api.twitterapi.io/twitter/list/followers?list_id=LIST_ID&cursor=CURSOR' \
