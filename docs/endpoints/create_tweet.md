...
- `tweet_text` (string, required): The text of the tweet.
- `quote_tweet_id` (string, optional): The id of the tweet to quote.Optional
- `in_reply_to_tweet_id` (string, optional): The id of the tweet to reply to.Optional
- `media_id` (string, optional): The id of the media to attach.Optional
...
_Scraped at: 2026-04-10T04:07:53.670961Z_
